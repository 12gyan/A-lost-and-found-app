...
const FeedbackForm = (props) => {
  ...
  return (
    <>
    <div className='body'>
      <div className="addnotes" style={{ margin: "auto" }}>
        <div className="right ps-5 pe-5 pt-4 mb-5" style={{ backgroundColor: `${props.theme === 'dark' ? '#333' : ''}`, color: `${props.theme === 'dark' ? '#f5f5f5' : '#333'}` }}>
          ...
          <form className={`feedback-form ${props.theme === 'dark' ? 'dark-mode' : ''}`} onSubmit={handleSubmit}>
            ...
            <Button type="submit" variant="contained" color="primary" className="my-3 mb-4" style={{ textTransform: "none", borderRadius: "15px", fontFamily: "'Poppins', sans-serif", fontSize: "1rem" }}>Submit</Button>
          </form>
        </div>
      </div>
    </div>
